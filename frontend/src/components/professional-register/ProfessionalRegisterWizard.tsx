...
import { ProfessionalRegisterStepIndicator } from './ProfessionalRegisterStepIndicator';
...
import { ProfessionalRegisterSuccess } from './ProfessionalRegisterSuccess';
import { formFromInvite, GRADIENT_BG, type FieldErrors, type Step, type WizardFormState } from './types';
...
export function ProfessionalRegisterWizard({ token, invite }: ProfessionalRegisterWizardProps) {
      ...
      <div className="bg-card border border-border rounded-3xl shadow-xl shadow-primary/5 p-6 sm:p-8 w-full max-w-[480px]">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Convite para <strong className="text-primary font-bold">{ROLE_LABEL[invite.role]}</strong>
