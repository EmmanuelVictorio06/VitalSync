 ...
 * para o login. Visualmente coerente com a tela de sucesso do registro de
 * sinais vitais (mesma linguagem de animação/cores).
 */
...
/** Fundo suave (cinza muito claro → azul muito claro), igual ao do wizard. */
